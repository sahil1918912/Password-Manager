...
import com.example.password_manager.Repository.Repository
...
class MainViewModel @Inject constructor(private val repository : Repository) : ViewModel() {
    ...
    private val _passwordList = MutableStateFlow<List<PassEntity>>(emptyList())
    ...
    fun AddPassword(passwordEntity: PassEntity)=viewModelScope.launch {
        loading.value = true
        delay(2000L)
    ...
    fun Delete(passwordEntity: PassEntity)=viewModelScope.launch {
        loading.value = true
        delay(2000L)
    ...
    fun Update(passwordEntity: PassEntity)=viewModelScope.launch {
        loading.value = true
        delay(2000L)
